    ...
    return (
        ...
        <form onSubmit={(e)=>e.preventDefault()} className="flex flex-wrap shadow md:py-16 rounded-md bg-white w-full p-6 mt-20 md:w-800 m-auto">
            <div className="md:flex md:flex-wrap md:w-full md:justify-between">
                <InputField value={burnValue} handleChange={setBurnValue} col="red400" borderCol="red400border" labelText="Send DAI (Stable USD Token) wk1 $5/token" textColor="red-400" tokenName="DAI (Stable USD Token) " tokenValue={oldTokenBalance} />
        ...
        <div className="flex flex-wrap justify-between w-full px-6 mt-10 md:w-800 m-auto">
                ...
                <Button onClick={handleBurn} disabled={(!enoughAllowance&&Number(burnValue)>oldTokenAllowance)||burnValue==""} text="Get DGOVn token" bgActive="greenish" bgInactive="white" />
        </div>
